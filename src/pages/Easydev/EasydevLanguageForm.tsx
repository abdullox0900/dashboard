...
type ProgrammingLang = ProgrammingLangInner[]

export const EasydevLanguageForm = () => {

    const [languageName, setLanguageName] = useState<string>()


    const { data, refetch } = useFetchData<ProgrammingLang>(`${'http://localhost:4000/'}programming-languages`)
    ...
    return (
        <div>
            <Breadcrumb pageName="Form Language" />
            {/* General Loader */}
                ...
                <div className="h-min rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    ...
                    <div className="p-6.5">
                        <div className="mb-4.5">
                            ...
                            <input
                                type="text"
                                placeholder="Enter your full language name (JavaScript, Python)"
                                value={languageName}
